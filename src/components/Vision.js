...
const data = [
  {
    ...
    description:
      "Our goal is to create a setting where students feel free to experiment with new ideas and where innovation is encouraged.",
  },
  {
    id: 2,
    title: "Fostering Collaboration",
    description:
      " We give teachers and students the tools and assistance they need to work together productively and transform ideas into real initiatives.",
  },
  {
    id: 3,
    title: "Promoting Entrepreneurship",
    description:
      "We want to help students develop an entrepreneurial attitude by giving them the tools and chances to lead innovation and effect good change.",
  },
];
...
const Card = ({
  ...
  return (
    <div
      className={`flex flex-col w-full border-opacity-40 border-black py-3 md:py-4 gap-2 cursor-pointer ${
        !isOpen && "opacity-40  border-b-2"
      }`}
    ...
    >
      ...
      {isOpen && (
        <div className="grid grid-cols-10">
          <p className="font-normal text-xs md:text-lg col-span-10">
            {description}
          </p>
        </div>
      )}
...
const Vision = () => {
  ...
  return (
    <div className="w-full px-6 md:px-24 pb-8 md:pb-20" id="vision">

                        ...
                        <div className="col-md-6 text-md-start text-center">
                            ...
                            <div className="text-center text-md-start">
                                <div className="header-social-links d-flex align-items-center">
                                    <a href="https://www.instagram.com/iedc.cusat/" target="blank" className="instagram m-0">
                                    ...
                                    <a href="https://www.linkedin.com/company/iedc-cusat/" target="blank" className="linkedin">
